            ...
            <div class="col-lg-6">
                <div class="d-flex custom-card">
                    ...
                    <div class="text">
                        ...
                        <p>
                            <a href="{{ route('service_details','interior-design') }}" class="more-2">Learn more<span class="icon-arrow_forward"></span></a>
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="d-flex custom-card">
                    ...
                    <div class="text">
                        ...
                        <p>
                            <a href="{{ route('service_details','landscape-design') }}" class="more-2">Learn more<span class="icon-arrow_forward"></span></a>
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="d-flex custom-card">
                    ...
                    <div class="text">
                        ...
                        <p>
                            <a href="{{ route('service_details','architecture-design') }}" class="more-2">Learn more<span class="icon-arrow_forward"></span></a>
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="d-flex custom-card">
                    ...
                    <div class="text">
                        ...
                        <p>
                            <a href="{{ route('service_details','floor-plan') }}" class="more-2">Learn more<span class="icon-arrow_forward"></span></a>
                        </p>
                    </div>
                </div>
            </div>
